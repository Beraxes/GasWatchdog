    ...
    <ion-content class="ion-padding">
      <div class="login-container">
        <ion-card class="login-card">
          <div class="salesIcon">
            <input type="image" class="salesI" src="/resources/LogoNombre.png">
          </div>
          <ion-card-header class="login-header">
            <ion-card-title>Bienvenido!</ion-card-title>
            <ion-card-subtitle>Ingresa para continuar</ion-card-subtitle>
          </ion-card-header>
          <ion-card-content>
            <ion-item>
            ...
            <ion-button expand="full" shape="round" @click="login" color="primary">Iniciar Sesion</ion-button>
            <div class="forgot-password">
              <ion-label href="/tabs" @click="forgotPassword"> <a href="/tabs">Olvidaste la cotraseña?</a> </ion-label>
            </div>
